import { ArrowUpRight, Bell, Briefcase, CheckCircle, Clock, DollarSign, MessageSquare, PlusCircle } from "lucide-react"
  ...
  const notifications = [
    {
      ...
      description: "John Smith submitted a proposal for your web design project",
      time: "10 minutes ago",
      type: "proposal",
    },
    {
      ...
      description: "Mobile App UI Design project milestone has been completed",
      time: "2 hours ago",
      type: "project",
    },
    {
      ...
      description: "Sarah sent you a message about the logo design project",
      time: "Yesterday",
      type: "message",
    },
    {
              ...
              {activeProjects.map((project) => (
                <div key={project.id} className="flex flex-col space-y-2 rounded-lg shadow-sm  p-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-500">{project.freelancer}</span>
                  </div>
        ...
        <div className="col-span-1 rounded-lg   bg-white   shadow-sm">
          ...
          <div className="p-4">
            <div className="space-y-4">
              {notifications.map((notification) => (
                <div key={notification.id} className="flex gap-3 rounded-lg shadow-sm  p-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary/10">
                    {notification.type === "proposal" && <Briefcase className="h-4 w-4 text-primary" />}
              ...
              <button className="w-full py-2 px-4   border-gray-300 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
