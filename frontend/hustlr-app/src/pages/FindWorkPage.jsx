...
import { JobServices } from "../services/projectServices";

function FindWorkPage() {
  // State for jobs fetched from the API
  const [jobs, setJobs] = useState([]);
  ...
  // All available skills and categories (dynamically fetched from jobs)
    ...
    const fetchJobs = async () => {
      try {
        ...
        if (Array.isArray(jobsData)) {
          ...
          // Extract skills and categories dynamically
          ...
          console.error("Unexpected API response:", jobsData);
        }
      } catch (error) {
